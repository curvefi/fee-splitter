...
def test_expected_behavior(manager, crvusd, bribe_manager, bribe_poster,
...
def test_zero_address(crvusd, bribe_manager, bribe_poster, token_rescuer, emergency_admin):
